-- ======================================================================
-- S7 — marketplace_account_sync_jobs — evolução fila (fase 2 SaaS)
-- Aplicar manualmente no Supabase SQL Editor quando for adotar locks/priority.
-- O worker atual NÃO depende destas colunas (retrocompatível sem rodar isto).
-- ======================================================================
