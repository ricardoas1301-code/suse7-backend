-- Canonical: marketplace_account_sales_import_coverage
-- Origem: scripts/migrations/20260508_marketplace_account_sales_import_coverage.sql
-- Posição: após marketplace_account_sync_jobs (20260510120000)
