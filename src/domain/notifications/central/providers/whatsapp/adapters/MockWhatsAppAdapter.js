...
export class MockWhatsAppAdapter extends ProviderAdapter {
  constructor() {
    super({
      channel: S7_PROVIDER_CHANNEL.WHATSAPP,
      providerName: "mock",
      deliveryMode: S7_DELIVERY_MODE.MOCK,
      capabilities: MOCK_WHATSAPP_CAPABILITIES,
    });
  }
  ...
  async send(input) {
    ...
    return toProviderResponse({
      ...
      raw: { mock: true },
      metadata: { delivery_mode: S7_DELIVERY_MODE.MOCK },
    });
  }
}
