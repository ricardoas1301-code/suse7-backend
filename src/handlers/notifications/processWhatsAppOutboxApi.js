// =============================================================================
// POST /api/internal/notifications/whatsapp/process — worker outbox WhatsApp (DEV/job)
// Header: X-S7-Internal-Secret ou X-Job-Secret
// =============================================================================

import { createClient } from "@supabase/supabase-js";
import { config } from "../../infra/config.js";
import { processWhatsAppOutbox } from "../../domain/notifications/central/whatsapp/processWhatsAppOutbox.js";
...
export async function handleProcessWhatsAppOutbox(req, res) {
  ...
  try {
    const result = await processWhatsAppOutbox(supabase, { batchSize });
    if (!result.ok) {
