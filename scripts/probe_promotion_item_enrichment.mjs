...
const ext = process.argv[2] ?? "MLB6784329822";
const pid = process.argv[3] ?? "P-MLB17759006";
const ptype = process.argv[4] ?? "DEAL";
...
const items = await fetchSellerPromotionItemsForListing(token, pid, ptype, ext);
