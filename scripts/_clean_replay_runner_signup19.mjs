...
const BACKEND_ROOT = process.env.CLEAN_BACKEND_ROOT || path.join(__dirname, "..");
const FRONTEND_ROOT = process.env.CLEAN_FRONTEND_ROOT || path.join(BACKEND_ROOT, "..", "suse7-frontend");
